    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a href="javascript:window.location.href=window.location.href"><img src="assets/logo.png" alt="merkery_logo" class="hidden-xs hidden-sm">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="FamilyTreePage.php"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Family Tree</span></a></li>
